#'
#' Parity 1
#' Check distribution SCC =1. Should it be removed?
#' 
library(tidyverse)
library(lubridate)
library(broom)
...
rm(df1_neg, df1_pos, df2_pos, df2_neg, df3_neg, df3_pos, df4_neg, df4_pos); gc()
#'
#' df_model: Holstein, con, PCR tested, 0<SCC<9999
#' all_herds: no PCR info, holstein, con, SCCpost (not 0,999 filtered), DIM 0-349
#'
#'
# all_herds <- df_model %>%
#   ungroup() %>%

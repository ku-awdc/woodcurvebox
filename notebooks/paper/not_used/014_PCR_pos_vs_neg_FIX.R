...
# keeping only df_all, since this has all parities and PCR status
rm(df_model, df1, df1_pos, df1_neg, df2, df2_neg, df2_pos, df3, df4, df4_pos, df4_neg)
gc()


# FIX: include PARITY, KONTROLDATO by using the df_all data
